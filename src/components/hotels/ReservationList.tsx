...
if(data.success){
  ...
  return (
    ...
    {reservationList&& reservationList.map((reservation,index)=>
        ...
        <ListItemIcon  sx={{flexGrow:'0',display:'flex',justifyContent:'left'}}  ><Image  width={100} height={130} alt='AirLine' style={{objectFit:"contain"}}   src={reservation.place.photo.images.small.url} /> </ListItemIcon>
        <Box display={'flex'} padding={'0 10%'} justifyContent="center" textAlign={'left'} flexGrow={3} flexWrap="wrap">
