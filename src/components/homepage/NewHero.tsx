...
<Typography className={`${heebo.className} ${styles.header}`} fontWeight={"bold"} variant="h1" >The only travel site you will need</Typography>
<Image priority sizes='250px' className={styles.logo}  alt='travel buddy'  src={RoundLogo}   />
</Box>
<Typography className={`${heebo.className} ${styles.sub}`}>Travel Buddy offers an all in one travel tool packed with everything 
